...
public class NoOpAIProvider implements AIProvider {
  ...
  public AIResponse execute(AIRequest request, String promptText) {
    ...
    String stubJsonResponse =
        """
        {
          "possibleCondition": "Simulated Assessment (NoOp Development Stub)",
          "confidence": 0.00,
          "severity": "UNKNOWN",
          "observations": [
            "NoOp AI Provider active — real machine learning inference disabled or not configured in this environment"
          ],
          "recommendedNextStep": "Configure a valid AI Provider (e.g. Google Gemini with GEMINI_API_KEY) for live clinical vision analysis.",
          "requiresVeterinarianReview": true,
          "disclaimer": "This is a non-clinical development stub response generated by NoOpAIProvider."
        }
        """;
    return new AIResponse(

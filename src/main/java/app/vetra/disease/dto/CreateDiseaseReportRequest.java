...
public record CreateDiseaseReportRequest(
    ...
    UUID aiScanId,
    @NotNull(message = "Report source is required") DiseaseReportSource reportSource,
    ...
    @NotBlank(message = "Disease name is required")
        ...
        String diseaseName,
    @NotNull(message = "Diagnosis status is required") DiagnosisStatus diagnosisStatus,

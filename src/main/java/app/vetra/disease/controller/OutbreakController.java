 ...
 * GeoJSON map exports, spatial heatmaps, and disease registry.
 */
@RestController
@RequestMapping("/api/v1/disease")
@Tag(name = "Autonomous Disease Intelligence", description = "Endpoints for outbreak cluster intelligence, GeoJSON exports, spatial heatmaps, and registry")
...
public class OutbreakController {
  ...
  @Operation(summary = "Get Outbreak Velocity Trends", description = "Retrieves active outbreak clusters with spatial-temporal velocity trends.")
  ...
  @Operation(summary = "Get Outbreaks GeoJSON", description = "Exports active outbreak clusters as a valid RFC 7946 GeoJSON FeatureCollection.")
  ...
  @Operation(summary = "Get Outbreaks Spatial Heatmap", description = "Exports spatial heatmap hotspot dataset with normalized intensity weights (0.0 to 1.0).")
  ...
  @Operation(summary = "Get Disease Analytics", description = "Retrieves comprehensive epidemiological analytics and surveillance metrics.")
  ...
  @GetMapping("/registry")
  @Operation(summary = "Get Disease Registry", description = "Retrieves disease taxonomy metadata catalog.")
